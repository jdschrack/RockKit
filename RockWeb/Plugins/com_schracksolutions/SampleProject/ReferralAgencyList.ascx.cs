...
namespace RockWeb.Plugins.com_schracksolutions.SampleProject
{
    /// <summary>
    /// Lists all the Referral Agencies.
    /// </summary>
    [DisplayName( "Referral Agency List" )]
    [Category( "com_schracksolutions > Sample Project" )]
    ...
    public partial class ReferralAgencyList : Rock.Web.UI.RockBlock
    {
        ...
        private void BindFilter()
        {
            ...
            var definedType = DefinedTypeCache.Read( com.schracksolutions.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() );
            if ( definedType != null )
            {
